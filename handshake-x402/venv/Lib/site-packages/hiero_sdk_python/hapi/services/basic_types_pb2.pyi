...
class SubType(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    CRYPTO_TRANSFER_WITH_HOOKS: _ClassVar[SubType]
...
class HederaFunctionality(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    ...
    HookStore: _ClassVar[HederaFunctionality]
    LedgerIdPublication: _ClassVar[HederaFunctionality]
    RegisteredNodeCreate: _ClassVar[HederaFunctionality]
    RegisteredNodeUpdate: _ClassVar[HederaFunctionality]
    RegisteredNodeDelete: _ClassVar[HederaFunctionality]
    MigrationRootHashVote: _ClassVar[HederaFunctionality]
...
CRYPTO_TRANSFER_WITH_HOOKS: SubType
...
HookStore: HederaFunctionality
LedgerIdPublication: HederaFunctionality
RegisteredNodeCreate: HederaFunctionality
RegisteredNodeUpdate: HederaFunctionality
RegisteredNodeDelete: HederaFunctionality
MigrationRootHashVote: HederaFunctionality
...
class HookEntityId(_message.Message):
    __slots__ = ("account_id", "contract_id")
    ACCOUNT_ID_FIELD_NUMBER: _ClassVar[int]
    CONTRACT_ID_FIELD_NUMBER: _ClassVar[int]
    account_id: AccountID
    contract_id: ContractID
    def __init__(self, account_id: _Optional[_Union[AccountID, _Mapping]] = ..., contract_id: _Optional[_Union[ContractID, _Mapping]] = ...) -> None: ...

class HookCall(_message.Message):
    __slots__ = ("hook_id", "evm_hook_call")
    HOOK_ID_FIELD_NUMBER: _ClassVar[int]
    EVM_HOOK_CALL_FIELD_NUMBER: _ClassVar[int]
    hook_id: int
    evm_hook_call: EvmHookCall
    def __init__(self, hook_id: _Optional[int] = ..., evm_hook_call: _Optional[_Union[EvmHookCall, _Mapping]] = ...) -> None: ...
