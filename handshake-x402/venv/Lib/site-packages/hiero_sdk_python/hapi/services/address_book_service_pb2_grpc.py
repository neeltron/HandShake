...
from ..services import transaction_pb2 as services_dot_transaction__pb2
from ..services import transaction_response_pb2 as services_dot_transaction__response__pb2
...
class AddressBookServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.updateNode = channel.unary_unary(
                ...
                response_deserializer=services_dot_transaction__response__pb2.TransactionResponse.FromString,
                _registered_method=True)
        self.createRegisteredNode = channel.unary_unary(
                '/proto.AddressBookService/createRegisteredNode',
                request_serializer=services_dot_transaction__pb2.Transaction.SerializeToString,
                response_deserializer=services_dot_transaction__response__pb2.TransactionResponse.FromString,
                _registered_method=True)
        self.deleteRegisteredNode = channel.unary_unary(
                '/proto.AddressBookService/deleteRegisteredNode',
                request_serializer=services_dot_transaction__pb2.Transaction.SerializeToString,
                response_deserializer=services_dot_transaction__response__pb2.TransactionResponse.FromString,
                _registered_method=True)
        self.updateRegisteredNode = channel.unary_unary(
                '/proto.AddressBookService/updateRegisteredNode',
                request_serializer=services_dot_transaction__pb2.Transaction.SerializeToString,
                response_deserializer=services_dot_transaction__response__pb2.TransactionResponse.FromString,
                _registered_method=True)
...
class AddressBookServiceServicer(object):
    ...
    def createRegisteredNode(self, request, context):
        """*
    ...
    def deleteRegisteredNode(self, request, context):
        """*
    ...
    def updateRegisteredNode(self, request, context):
        """*
...
def add_AddressBookServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'createRegisteredNode': grpc.unary_unary_rpc_method_handler(
                    servicer.createRegisteredNode,
                    request_deserializer=services_dot_transaction__pb2.Transaction.FromString,
                    response_serializer=services_dot_transaction__response__pb2.TransactionResponse.SerializeToString,
            ),
            'deleteRegisteredNode': grpc.unary_unary_rpc_method_handler(
                    servicer.deleteRegisteredNode,
                    request_deserializer=services_dot_transaction__pb2.Transaction.FromString,
                    response_serializer=services_dot_transaction__response__pb2.TransactionResponse.SerializeToString,
            ),
            'updateRegisteredNode': grpc.unary_unary_rpc_method_handler(
                    servicer.updateRegisteredNode,
                    request_deserializer=services_dot_transaction__pb2.Transaction.FromString,
                    response_serializer=services_dot_transaction__response__pb2.TransactionResponse.SerializeToString,
            ),
    }
...
class AddressBookService(object):
    ...
    @staticmethod
    def createRegisteredNode(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def deleteRegisteredNode(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
    ...
    @staticmethod
    def updateRegisteredNode(request,
            target,
            options=(),
            channel_credentials=None,
            call_credentials=None,
