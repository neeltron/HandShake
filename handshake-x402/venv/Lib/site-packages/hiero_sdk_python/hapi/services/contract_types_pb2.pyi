...
class EvmTransactionResult(_message.Message):
    __slots__ = ("sender_id", "contract_id", "result_data", "error_message", "gas_used", "internal_call_context", "executed_hook_id", "contract_nonces", "signer_nonce")
    ...
    EXECUTED_HOOK_ID_FIELD_NUMBER: _ClassVar[int]
