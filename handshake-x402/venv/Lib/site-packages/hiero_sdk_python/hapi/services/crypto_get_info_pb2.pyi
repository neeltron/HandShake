...
from ..services import query_header_pb2 as _query_header_pb2
from ..services import response_header_pb2 as _response_header_pb2
...
class CryptoGetInfoResponse(_message.Message):
    ...
    class AccountInfo(_message.Message):
        ...
        DELEGATION_ADDRESS_FIELD_NUMBER: _ClassVar[int]
        accountID: _basic_types_pb2.AccountID
