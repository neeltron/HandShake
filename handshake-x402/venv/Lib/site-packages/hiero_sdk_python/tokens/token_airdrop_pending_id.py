...
class PendingAirdropId:
    ...
    def __init__(
        self, sender_id: AccountId, receiver_id: AccountId, token_id: TokenId | None = None, nft_id: NftId | None = None
    ) -> None:
        """
        ...
        Args:
            ...
            token_id (TokenId. optional): The ID of the fungible token being airdropped.
            nft_id (NftId, optional): The ID of the non-fungible token being airdropped.
        """
    ...
    def __str__(self) -> str:
        """Readable summary."""
        if self.nft_id:
            return f"PendingAirdropId(sender_id={self.sender_id}, receiver_id={self.receiver_id}, nft_id={self.nft_id})"
        return (
            f"PendingAirdropId("
    ...
    def __eq__(self, other: object) -> bool:
        ...
        return (
            ...
            and self.receiver_id == other.receiver_id
            and self.token_id == other.token_id
            and self.nft_id == other.nft_id
        )
