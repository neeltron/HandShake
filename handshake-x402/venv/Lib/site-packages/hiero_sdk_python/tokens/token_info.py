...
class TokenInfo:
    ...
    kyc_key: PublicKey | None = None
    freeze_key: PublicKey | None = None
    wipe_key: PublicKey | None = None
    supply_key: PublicKey | None = None
    metadata_key: PublicKey | None = None
    fee_schedule_key: PublicKey | None = None
    default_freeze_status: TokenFreezeStatus = field(default_factory=lambda: TokenFreezeStatus.FREEZE_NOT_APPLICABLE)
    default_kyc_status: TokenKycStatus = field(default_factory=lambda: TokenKycStatus.KYC_NOT_APPLICABLE)
    auto_renew_account: AccountId | None = None
    auto_renew_period: Duration | None = None
    expiry: Timestamp | None = None
    pause_key: PublicKey | None = None
    ...
    @staticmethod
    def _public_key_from_oneof(key_msg) -> PublicKey | None:
    ...
    @staticmethod
    def _set_bool(dst_proto, field_name: str, value: bool | None, default: bool = False) -> None:
    ...
    @staticmethod
    def _append_custom_fees(dst_proto, fees: list[Any] | None) -> None:
